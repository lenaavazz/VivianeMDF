<?php
    ...
    class Email{
        ...
        public function __construct($host = null, $username = null, $senha = null, $nome = null){
            ...
            $this->mailer->Username = 'vivianemariavaz@gmailcom';   //SMTP usuário/email que vai enviar emails
            $this->mailer->Password = 'vi10192108';                            // SMTP senha do usuário/email que envia email
            $this->mailer->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
            $this->mailer->Port = 465;                                  // TCP port to connect to
            $this->mailer->setFrom('vivianemariavaz@gmailcom', 'Viviane Vaz MDF'); //Enviado de 
            $this->mailer->addReplyTo('vivianemariavaz@gmailcom', 'Viviane Vaz MDF'); //Responder para
