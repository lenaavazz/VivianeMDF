<?php
    ...
    if(isset($_SESSION['orcamentos'])){
        $orcamentos = json_decode($_SESSION["orcamentos"]);
    }
?>
<!DOCTYPE html>
<html lang="pt-br">
    ...
    <title>Viviane Vaz MDF - Tabela Orçamento</title>
                    ...
                    <table id="table_id" class="display">
                        <thead>
                            <tr>
                                ...
                                <td>data_entrega</td>
                                <td>descrição</td>
                                <th><a href="../cadastros/cadastro-orcamento.php" type="button" class="btn btn-primary" style="float: right;">
                                Cadastrar Orçamento</a></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            if ($orcamentos) {
                                foreach ($orcamentos as $orcamento) {
                                    ?>
                                    <tr>
                                        <td><?php echo $orcamento->produto; ?></td>
                                        <td><?php echo $orcamento->cliente; ?></td>
                                        <td><?php echo $orcamento->endereco_entrega; ?></td>
                                        <td><?php echo $orcamento->data_entrega; ?></td>
                                        <td><?php echo $orcamento->descricao; ?></td>
                                        <td>
                                            <a href="../controllers/controllerOrcamento.php?acao=del&id=<?php echo $orcamento->id; ?>" class="btn btn-danger btn-sm" style="float: right;">Excluir</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
